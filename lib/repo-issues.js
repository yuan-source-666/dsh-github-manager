...
export function registerRepoIssueTools(ctx, identity) {
    ...
    ctx.tools.register(defineTool({
        ...
        async execute(args) {
            const ref = args;
            assertRepo(ref);
            const res = await githubRequest(identity, 'GET', '/repos/' + ref.owner + '/' + ref.repo);
    ...
    ctx.tools.register(defineTool({
        ...
        async execute(args) {
            ...
            const res = await githubRequest(identity, 'POST', path, { body });
    ...
    ctx.tools.register(defineTool({
        ...
        async execute(args) {
            ...
            if (args.labels)
                path += '&labels=' + encodeURIComponent(args.labels);
            if (args.assignee)
                path += '&assignee=' + encodeURIComponent(args.assignee);
            const list = await githubListAll(identity, path, perPage);
    ...
    ctx.tools.register(defineTool({
        ...
        async execute(args) {
            ...
            const res = await githubRequest(identity, 'POST', '/repos/' + ref.owner + '/' + ref.repo + '/issues', { body });
    ...
    ctx.tools.register(defineTool({
        ...
        async execute(args) {
            ...
            const res = await githubRequest(identity, 'PATCH', '/repos/' + ref.owner + '/' + ref.repo + '/issues/' + args.number, { body });
    ...
    ctx.tools.register(defineTool({
        ...
        async execute(args) {
            ...
            assertRepo(ref);
            if (identity.dryRun)
                return { id: -1, url: '(dry-run)', dryRun: true };
            const res = await githubRequest(identity, 'POST', '/repos/' + ref.owner + '/' + ref.repo + '/issues/' + args.number + '/comments', { body: { body: args.body } });
